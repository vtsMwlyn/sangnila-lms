...
@section("content")
	<div class="flex flex-col w-full items-center">
		@if(session()->has("systemFail"))
			<x-badge-danger badge_text="{{ session('systemFail') }}" class="mb-5 w-11/12 md:w-2/3"></x-badge-danger>
		@endif

		<div class="flex items-stretch gap-5 rounded-2xl w-11/12 md:w-2/3 bg-orange-500 p-10 mb-5">
