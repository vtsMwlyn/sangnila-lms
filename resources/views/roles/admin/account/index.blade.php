							...
							<tr class="@if($loop->iteration % 2 == 1) bg-white @endif">
								...
								<td class="py-3 px-4">
									<div class="flex w-full items-stretch gap-1 justify-start">
										<button type="button" class="reset-password-btn h-8 w-8 flex items-center justify-center hover:scale-110" data-account_name="{{ $admin_acc->full_name }}" data-route="{{ route('admin.account.reset-password.proceed', $admin_acc->id) }}" title="Reset the password for this account">
											<img src="{{ asset('img/reset-password.svg') }}">
										</button>
										<a href="{{ route('admin.account.acc_edit', $admin_acc->id) }}" title="Edit this account data">
											<img src="{{ asset('img/edit.svg') }}" alt="icon" class="max-w-8 min-w-8 max-h-8 min-h-8 hover:scale-110">
										</a>
										<button type="button" class="disable-account-btn" data-account_name="{{ $admin_acc->full_name }}" data-route="{{ route('admin.account.acc_disable', $admin_acc->id) }}" title="Disable this account">
											<img src="{{ asset('img/ban.svg') }}" alt="icon" class="max-w-8 min-w-8 max-h-8 min-h-8 hover:scale-110">
										</button>
										<button type="button" class="delete-account-btn" data-account_name="{{ $admin_acc->full_name }}" data-route="{{ route('admin.account.acc_delete', $admin_acc->id) }}" title="Delete this account">
					...
					<tbody>
						@forelse ($teacher_accounts as $teacher_acc)
							<tr class="@if($loop->iteration % 2 == 1) bg-white @endif">
								...
								<td class="py-3 px-4">
									<div class="flex w-full items-stretch gap-1 justify-start">
										<button type="button" class="reset-password-btn h-8 w-8 flex items-center justify-center hover:scale-110" data-account_name="{{ $teacher_acc->full_name }}" data-route="{{ route('admin.account.reset-password.proceed', $teacher_acc->id) }}" title="Reset the password for this account">
											<img src="{{ asset('img/reset-password.svg') }}">
										</button>
										<a href="{{ route('admin.account.acc_edit', $teacher_acc->id) }}" title="Edit this account data">
											<img src="{{ asset('img/edit.svg') }}" alt="icon" class="max-w-8 min-w-8 max-h-8 min-h-8 hover:scale-110">
										</a>
										<button type="button" class="disable-account-btn" data-account_name="{{ $teacher_acc->full_name }}" data-route="{{ route('admin.account.acc_disable', $teacher_acc->id) }}" title="Disable this account">
											<img src="{{ asset('img/ban.svg') }}" alt="icon" class="max-w-8 min-w-8 max-h-8 min-h-8 hover:scale-110">
										</button>
										<button type="button" class="delete-account-btn" data-account_name="{{ $teacher_acc->full_name }}" data-route="{{ route('admin.account.acc_delete', $teacher_acc->id) }}" title="Delete this account">
											<img src="{{ asset('img/delete-button.svg') }}" alt="icon" class="max-w-8 min-w-8 max-h-8 min-h-8 hover:scale-110">
										</button>
									</div>
								</td>
					...
					<tbody>
						@forelse ($student_accounts as $student_acc)
							<tr class="@if($loop->iteration % 2 == 1) bg-white @endif">
								...
								<td class="py-3 px-4">
									<div class="flex w-full items-stretch gap-1 justify-start">
										<button type="button" class="reset-password-btn h-8 w-8 flex items-center justify-center hover:scale-110" data-account_name="{{ $student_acc->full_name }}" data-route="{{ route('admin.account.reset-password.proceed', $student_acc->id) }}" title="Reset the password for this account">
											<img src="{{ asset('img/reset-password.svg') }}">
										</button>
										<a href="{{ route('admin.account.acc_edit', $student_acc->id) }}" title="Edit this account data">
											<img src="{{ asset('img/edit.svg') }}" alt="icon" class="max-w-8 min-w-8 max-h-8 min-h-8 hover:scale-110">
										</a>
										<button type="button" class="disable-account-btn" data-account_name="{{ $student_acc->full_name }}" data-route="{{ route('admin.account.acc_disable', $student_acc->id) }}" title="Disable this account">
											<img src="{{ asset('img/ban.svg') }}" alt="icon" class="max-w-8 min-w-8 max-h-8 min-h-8 hover:scale-110">
										</button>
										<button type="button" class="delete-account-btn" data-account_name="{{ $student_acc->full_name }}" data-route="{{ route('admin.account.acc_delete', $student_acc->id) }}" title="Delete this account">
											<img src="{{ asset('img/delete-button.svg') }}" alt="icon" class="max-w-8 min-w-8 max-h-8 min-h-8 hover:scale-110">
										</button>
									</div>
								</td>
					...
					<tbody>
						@forelse ($disabled as $disabled_acc)
							<tr class="@if($loop->iteration % 2 == 1) bg-white @endif">
								...
								<td class="py-3 px-4">
									<div class="flex w-full items-stretch gap-1 justify-start">
										<button type="button" class="reset-password-btn h-8 w-8 flex items-center justify-center hover:scale-110" data-account_name="{{ $disabled_acc->full_name }}" data-route="{{ route('admin.account.reset-password.proceed', $disabled_acc->id) }}" title="Reset the password for this account">
											<img src="{{ asset('img/reset-password.svg') }}">
										</button>
										<a href="{{ route('admin.account.acc_edit', $disabled_acc->id) }}" title="Edit this account data">
											<img src="{{ asset('img/edit.svg') }}" alt="icon" class="max-w-8 min-w-8 max-h-8 min-h-8 hover:scale-110">
										</a>
										<button type="button" class="enable-account-btn" data-account_name="{{ $disabled_acc->full_name }}" data-route="{{ route('admin.account.acc_enable.conf', $disabled_acc->id) }}" title="Enable this account">
											<img src="{{ asset('img/unban.svg') }}" alt="icon" class="max-w-8 min-w-8 max-h-8 min-h-8 hover:scale-110">
										</button>
										<button type="button" class="delete-account-btn" data-account_name="{{ $disabled_acc->full_name }}" data-route="{{ route('admin.account.acc_delete', $disabled_acc->id) }}" title="Delete this account">
											<img src="{{ asset('img/delete-button.svg') }}" alt="icon" class="max-w-8 min-w-8 max-h-8 min-h-8 hover:scale-110">
										</button>
									</div>
								</td>
