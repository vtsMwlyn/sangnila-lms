...
@section("content")
	<h1 class="text-3xl font-semibold text-blue-900 mb-4">Delete Course</h1>
	<form method="POST" action="{{ route('admin.course.destroy', $course->id) }}" class="bg-white rounded-2xl p-5 border-blue-300 border-2">
		@csrf
		@method('delete')
		<!-- Confirmation Text -->
		<div class="mb-6">
