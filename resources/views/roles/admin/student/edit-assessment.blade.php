...
@section('content')
    <x-section-container>
        <x-back-button href="{{ route('admin.student.show', $assessment->student->id) }}"></x-back-button>
        ...
        <form action="{{ route('admin.student.update.assessment', $assessment->id) }}" method="post">
			...
			<div class="mt-2 flex flex-col w-full">
				<x-label for="custom_name">Custom Certificate Display Name <span class="italic text-slate-400">(Max 25 characters)</span></x-label>
