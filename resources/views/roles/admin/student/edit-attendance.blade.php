...
@section('content')
	<x-section-container>
		...
		<form action="{{ route('admin.student.edit-student-attendance', $student_attendance->id) }}" method="post" class="my-4">
			@csrf
			...
			<div id="form-area">
				...
				<div class="flex gap-5">
					...
					<div class="mt-3 w-full md:w-1/2">
						...
						<x-input type="text" name="_teacher_name" class="w-full" disabled value="{{ $cs->teacher->full_name }}"/>
					</div>
				</div>
