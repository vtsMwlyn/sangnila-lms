...
<body>
	<div class="bg-cover h-screen flex flex-col items-center"
		...
		<div class="container mx-auto mt-6 p-4 bg-white rounded-lg shadow-lg">
			<h1 class="text-3xl font-semibold text-blue-900 mb-4">Unassign Student</h1>
			<form method="POST" action="{{ route('admin.student.unassign.destroy', ['student_id' => $student->id, 'course_id' => $course->id]) }}" class="bg-white rounded-2xl p-5 border-blue-300 border-2">
				@csrf
				@method('DELETE')
				<!-- Confirmation Text -->
				<div class="mb-6">
