...
<body>
	<div class="bg-cover h-screen flex flex-col items-center"
		...
		<div class="container mx-auto mt-6 p-4 bg-white rounded-lg shadow-lg">
			...
			<div class="flex">
				<a class="px-5 py-2 bg-indigo-400 rounded-lg text-white hover:bg-gray-700 transition duration-300" href="#">Edit</a>
				<a class="px-5 py-2 bg-indigo-400 rounded-lg text-white hover:bg-gray-700 transition duration-300" href="#">Disable</a>
