...
@section("content")
	<x-section-container class="mb-10">
		...
		<div class="flex w-full flex-wrap mb-6">
			<a href="{{ route('head-of-lecturer.course.show', ['course' => $course->id, 'content' => 'general information']) }}"
			...
			<a href="{{ route('head-of-lecturer.course.show', ['course' => $course->id ,'content' => 'syllabus']) }}"
				class="py-2 w-1/2 xl:w-1/6 sm:w-48 text-center hover:bg-slate-200"
