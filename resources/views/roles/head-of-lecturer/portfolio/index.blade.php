...
@section("content")
    <div class="flex items-center justify-center w-full">
        <form class="flex w-1/2 justify-center" action="{{ route("head-of-lecturer.portfolio.index") }}">
	...
	<div class="w-full flex flex-wrap gap-5 mt-6 items-stretch">
		@forelse ($courses as $course)
			<a href="{{ route('head-of-lecturer.portfolio.show', $course->id) }}"  class="flex oneperthree transition duration-300 hover:scale-[102%] relative">
				<div class="rounded-3xl p-5 shadow-lg w-full" style="background-color: #FEFEFEB2;">
					...
					<div class="flex gap-2 items-center">
						<i class="bi bi-book-half text-slate-400"></i>{{ $course->portfolios->count() }} Portfolios Uploaded
					</div>
				</div>
			</a>
		@empty
