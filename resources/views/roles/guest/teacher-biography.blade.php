            ...
            <div class="mt-4 w-1/5 px-2">
                ...
                @else
                    @if($teacher->details->gender == 1)
                        <img src="{{ asset('img/tempblankprofpicmale.png') }}" class="w-full h-[250px] mt-2 mb-4 border-4 border-slate-400" alt="profpic" style="object-fit: cover; object-position: center; border-width: 3px;" loading="lazy">
                    @else
                        <img src="{{ asset('img/tempblankprofpicfemale.png') }}" class="w-full h-[250px] mt-2 mb-4 border-4 border-slate-400" alt="profpic" style="object-fit: cover; object-position: center; border-width: 3px;" loading="lazy">
                    @endif
                @endif
            </div>
