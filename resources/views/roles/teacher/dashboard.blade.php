...
@section("content")
	<x-section-container class="h-full">
		<div class="flex flex-col gap-8 w-full h-full items-center justify-center">
			<img src="{{ asset('img/coming-soon.png') }}" class="w-48" alt="coming-soon">
			<p class="text-xl text-blue font-semibold">Feature will be available soon~</p>
		</div>
