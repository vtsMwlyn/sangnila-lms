...
@section("content")
	<x-section-container>
		<x-page-title>New Reimburse</x-page-title>
		<div class="w-full bg-slate-400 mt-2 mb-3" style="height: 2px;"></div>

        <form action="{{ route('teacher.lecturer-invoice-reimburse.reimburse.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="flex gap-5">
                ...
                <div class="mt-3 w-full md:w-1/2">
                    ...
                    <x-input type="number" name="amount" id="amount" class="w-full" value="0" placeholder="Enter the amount of reimburse"/>
                </div>
            </div>
            ...
            <div class="flex gap-5">
                ...
                <div class="mt-3 w-full md:w-1/2">
                    ...
                    <x-input type="text" name="need" id="need" class="w-full" placeholder="(ex: Biaya transportasi ke GPS)"/>
                </div>
            </div>

            <div class="mt-4 hidden" id="img-preview-area">
                <p id="img-preview-label" class="mb-1">Image Preview</p>
                <img id="img-preview" class="w-1/2">
            </div>
