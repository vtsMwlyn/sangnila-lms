<footer class="px-5 py-10 mt-auto text-white bg-slate-800 bottom-0 w-full" id="footer">
    <div class="flex flex-col md:flex-row items-start justify-center gap-3">
        <div class="w-full w-1/2 lg:w-1/3 self-center px-4">
        ...
        <div class="w-full md:w-1/3 lg:w-1/4 flex flex-col items-start px-4">
        ...
        <div class="flex flex-row w-full lg:w-1/3 px-4">
            <div class="w-1/3 md:w-1/2 flex flex-col items-start mt-6 lg:mt-0">
            ...
            <div class="w-1/3 lg:w-1/2 flex flex-col items-start mt-6 lg:mt-0">
