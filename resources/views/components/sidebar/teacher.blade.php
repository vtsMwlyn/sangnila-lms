...
<div class="text-white z-10 min-h-screen w-[75%] md:w-[40%] xl:w-[17%] fixed xl:static hidden xl:block" id="sidebar-container">
	<div class="flex flex-col items-stretch sticky z-0 m-0 w-full" style="background: url({{ asset('img/sidebar-bg.webp') }}) no-repeat center left; background-size: cover;" id="sidebar">
		...
		<div class="flex flex-col items-stretch justify-center w-full text-base" id="large-sidebar">
			<x-anchor-button class="w-full grow flex justify-between items-center text-start gap-4 py-3 px-6"
			    ...
			    <div class="w-1/8">
				    <img src="{{ asset('img/sidebar-dashboard.svg') }}" class="h-6 w-8" alt="sidebar-icon">
				</div>
				<div class="flex flex-col w-7/8"><h3>Dashboard</h3><span class="text-xs font-normal">Find out helpful widgets made special for helping you</span></div>
			</x-anchor-button>
			...
			<x-anchor-button class="w-full grow flex justify-between items-center text-start gap-4 py-3 px-6"
			    ...
			    <div class="w-1/8">
				    <img src="{{ asset('img/sidebar-courses.svg') }}" class="h-6 w-8" alt="sidebar-icon">
				</div>
				<div class="flex flex-col w-7/8"><h3>Manage Courses</h3><span class="text-xs font-normal">Find out syllabus and your class info here</span></div>
			...
			<x-anchor-button class="w-full grow flex justify-between items-center text-start gap-4 py-2 px-6"
				...
				<div class="w-1/8">
				    <i class="bi bi-person-fill text-3xl mr-0.5"></i>
				</div>
				<div class="flex flex-col w-7/8"><h3>Manage Students</h3><span class="text-xs font-normal">Find out each student's portfolio and assessment here</span></div>
			...
			<x-anchor-button class="w-full grow flex items-center text-start gap-4 py-3 px-6"
			...
			<x-anchor-button class="grow flex justify-between items-center text-start gap-4 py-3 px-6"
				...
				<div class="w-1/8">
				    <img src="{{ asset('img/sidebar-attendance.svg') }}" class="h-6 w-8" alt="sidebar-icon">
				</div>
				<div class="flex flex-col w-7/8"><h3>Manage Attendance</h3><span class="text-xs font-normal">Find out you and your students attendance info here</span></div>
			</x-anchor-button>
