...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
		...
		$this->call([
			...
			TopicsAndActivitiesSeeder::class,
		...
		$newAnnouncement = Announcement::create([
			...
			"content" => "<div><strong>Welcome to </strong><strong><em>Sangnila Learning Management System</em></strong><strong>!!</strong><br><br>This web application is made to control learning activity in Sangnila <em>Arts Academy</em>. Here teachers can post topics and activities also assignments that can be access by students and upload attendance report. Also the learning activity data is able to be monitored by our admin and can be used for other needs.<br><br><strong>Change logs:</strong><br><br><ul><li>Added notification inboxes for teachers after students submit their assignment</li><li>Added notification inboxes for students after the teacher posted assignments, unlocked activities, and commented on submissions</li><li>Added undo button for undo check all students when teachers uploading new assignments</li><li>Bug fixes in edit attendance page</li></ul><br>Hope you enjoy the application, and if you encounter a problem please kindly contact us. Our team will help and assist you. Happy learning~<br><br><br>Best regard,<br>Sangnila <em>Arts Academy</em></div>",
