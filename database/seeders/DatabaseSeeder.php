...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::create(["email" => "admin.sangnila@gmail.com", "full_name" => "Admin", "password" => bcrypt("password"), "email_verified_at" => now(), "role_id" => 1, "status" => "enabled"]);

		/*COMMENT BELOW COMMANDS TO SET THE APP DATA TO COMPLETELY EMPTY*/
		User::create(["email" => "hari.sangnila@gmail.com", "full_name" => "Hari", "password" => bcrypt("password"), "email_verified_at" => now(), "role_id" => 2, "status" => "enabled"]);
		User::create(["email" => "benita.sangnila@gmail.com", "full_name" => "Benita", "password" => bcrypt("password"), "email_verified_at" => now(), "role_id" => 2, "status" => "enabled"]);
		User::create(["email" => "emily.sangnila@gmail.com", "full_name" => "Emily", "password" => bcrypt("password"), "email_verified_at" => now(), "role_id" => 2, "status" => "enabled"]);

		User::create(["email" => "jack.sangnila@gmail.com", "full_name" => "Jack", "password" => bcrypt("password"), "email_verified_at" => now(), "role_id" => 3, "status" => "enabled"]);
		User::create(["email" => "jillian.sangnila@gmail.com", "full_name" => "Jillian P. Tanuwijaya", "password" => bcrypt("password"), "email_verified_at" => now(), "role_id" => 3, "status" => "enabled"]);
		User::create(["email" => "jocheli.sangnila@gmail.com", "full_name" => "Jocheli Kensi Budianti", "password" => bcrypt("password"), "email_verified_at" => now(), "role_id" => 3, "status" => "enabled"]);
		User::create(["email" => "bellrich.sangnila@gmail.com", "full_name" => "Bellrich Kevin Tjahyadi", "password" => bcrypt("password"), "email_verified_at" => now(), "role_id" => 3, "status" => "enabled"]);
		User::create(["email" => "batara.sangnila@gmail.com", "full_name" => "Batara Feodore Setiawan", "password" => bcrypt("password"), "email_verified_at" => now(), "role_id" => 3, "status" => "enabled"]);
		User::create(["email" => "benedict.sangnila@gmail.com", "full_name" => "Benedict Jacob", "password" => bcrypt("password"), "email_verified_at" => now(), "role_id" => 3, "status" => "enabled"]);
		...
		CourseStudent::create(["course_id" => 2, "user_id" => 6]);
		CourseStudent::create(["course_id" => 2, "user_id" => 7]);
		CourseStudent::create(["course_id" => 4, "user_id" => 8]);
		CourseStudent::create(["course_id" => 4, "user_id" => 9]);
		CourseStudent::create(["course_id" => 4, "user_id" => 10]);
    }
}
